...
import java.util.function.Predicate;
    ...
    public class FireworkGunModel extends ShootableItem implements IVanishable {
        private boolean isLoadingStart = false;
        private boolean isLoadingMiddle = false;

   public FireworkGunModel() {
        ...
        public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
            ...
            System.out.println(isCharged(itemstack));
            if (isCharged(itemstack)) {
                ...
                System.out.println("there IS ammo");
                if (!isCharged(itemstack)) {
        ...
        public void onPlayerStoppedUsing(ItemStack stack, World worldIn, LivingEntity entityLiving, int timeLeft) {
            ...
            if (f >= 1.0F && !isCharged(stack) && hasAmmo(entityLiving, stack)) {
                ...
                System.out.println("it is now charged");
        ...
        @OnlyIn(Dist.CLIENT)
        public void addInformation(net.minecraft.item.ItemStack
        stack, @Nullable World worldIn, List< ITextComponent > tooltip, ITooltipFlag flagIn) {
            List<ItemStack> list = getChargedProjectiles(stack);
        ...
        private static float func_220013_l(net.minecraft.item.ItemStack p_220013_0_) {
